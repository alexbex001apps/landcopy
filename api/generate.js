...
Responde SOLO con este JSON sin markdown:
{
  ...
  if(o.images) {
    jsonFields.push(`"image_prompts":"1. [Prompt estilo Midjourney completo: escena especifica con persona usando el producto, descripcion detallada de ropa, expresion facial, postura corporal, ambiente y decoracion del lugar, hora del dia, tipo de iluminacion (luz natural dorada, luz de estudio suave, etc), estilo fotografico (fotografia lifestyle, editorial, comercial), tipo de camara y lente (Sony A7III, lente 85mm f/1.4), profundidad de campo, colores dominantes, mood o atmosfera, ultra detallado, 8k, hiperealista, premiun quality --ar 4:5]\\n\\n2. [Prompt estilo Midjourney: close-up extremo del producto, superficie y textura del material visible, reflexos y brillos controlados, fondo degradado neutro o color de marca, sombras suaves difusas, iluminacion de tres puntos estudio profesional, fotografia de producto ecommerce premium, sharp focus, studio lighting, product photography, white background, ultra HD, --ar 1:1]\\n\\n3. [Prompt estilo Midjourney: persona real mostrando el beneficio o resultado despues de usar el producto, emocion genuina de satisfaccion y alivio, ambiente cotidiano autentico del pais objetivo, luz natural ventana, fotografia documental lifestyle, cinematic color grading, bokeh background, shallow depth of field, --ar 4:5]\\n\\n4. [Prompt estilo Midjourney: composicion aspiracional del producto en contexto de uso ideal, ambiente premium y aspiracional, personas felices en segundo plano, golden hour lighting, colores calidos, atmosfera de exito y bienestar, wide angle shot, environmental portrait, lifestyle brand photography, --ar 16:9]\\n\\n5. [Prompt estilo Midjourney: flat lay cenital del producto con accesorios complementarios cuidadosamente dispuestos, superficie de marmol blanco o madera natural, flores secas o elementos naturales decorativos, composicion simetrica perfecta, sombras suaves laterales, colores neutros con acento del color del producto, overhead shot, commercial product photography, minimalist aesthetic, --ar 1:1]"`);
